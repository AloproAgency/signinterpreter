...
MOTION_END_THRESHOLD = 0.018     # original — preserves sign tail for classifier
MOTION_END_FRAMES = 6            # ~200 ms at 30 FPS — keeps full handshape intact
MIN_SIGN_FRAMES = 4              # ~130 ms — below this the 30-frame resample is junk
MAX_SIGN_FRAMES = 120            # ~4 s at 30 FPS

# Prediction — intermediate-only (UI feedback, not final accuracy)
PREDICT_AFTER_N_FRAMES = 5       # ~170 ms, first intermediate verdict (was 8)
PREDICT_EVERY_N_FRAMES = 3       # ~100 ms cadence (was 5)
